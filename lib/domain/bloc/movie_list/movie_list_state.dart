...
class MovieListSuccess extends MovieListState {
  ...
  const MovieListSuccess({this.movieList, this.hasReachedMax}):assert(hasReachedMax!=null);
  ...
  @override
  List<Object> get props => [movieList, hasReachedMax] as List<Object>;
...
class MovieListError extends MovieListState {
  ...
  @override
  List<Object> get props => [errorCode] as List<Object>;
}
