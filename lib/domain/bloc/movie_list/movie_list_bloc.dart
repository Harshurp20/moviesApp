...
class MovieListBloc extends Bloc<MovieListEvent, MovieListState> {
  ...
  MovieListBloc({this.movieRepository , this.movieListState}) : assert(movieRepository != null), super(movieListState as MovieListState);
  ...
  void _updatePageValue(dynamic page) {
    if (page >= 1) pageValue = page + 1;
  }

  bool _hasReachedMax(MovieListState state){
    if (state is MovieListSuccess && state.hasReachedMax != null) {
      return state.hasReachedMax as bool;
